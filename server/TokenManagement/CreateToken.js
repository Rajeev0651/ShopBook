...
function AccessToken(UserId, Name, Owner) {
...
function RefreshToken(UserId, Name, Owner) {
...
function AccessAndRefreshToken(UserId, Name, Owner) {
  const accesstokenkey = AccessToken(UserId, Name, Owner);
  const refreshtokenkey = RefreshToken(UserId, Name, Owner);
